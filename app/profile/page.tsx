...
import { socials, timeline } from "../site-data";
  ...
  return (
    <PageShell>
      ...
      <section className="momentsSection" aria-labelledby="moments-title">
        <div className="sectionHead"><p className="sectionLabel">Selected images</p><div><h2 id="moments-title">Professional moments.<br /><em>Inside the work.</em></h2><p className="sectionIntro">A few glimpses of the teams, stages, and market-facing environments behind the formal job titles.</p></div></div>
