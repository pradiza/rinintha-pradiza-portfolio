  ...
  return (
    <PageShell>
      <section className="contactPage">
        ...
        <div className="contactOptions"><a href={`mailto:${email}?subject=Project%20enquiry%20for%20Rinintha`}>Project enquiry <span>↗</span><small>Strategy, campaigns, research, events, and special projects</small></a><a href="/consultation">Indonesia consultation <span>↗</span><small>60-minute Indonesia Market Entry Strategy Call · View details and rate</small></a><a href={`mailto:${email}?subject=Role%20opportunity%20for%20Rinintha`}>Role opportunity <span>↗</span><small>Permanent, fractional, or senior project leadership</small></a><a href={`mailto:${email}?subject=MC%20or%20translation%20enquiry`}>MC / translation <span>↗</span><small>Indonesian–English stage work and selected localization</small></a></div>
        <div className="corporateEngagement"><span>Formal contracting</span><p>Rinintha leads the work personally. Consultations and larger projects requiring formal contracting, invoicing, vendor onboarding, or local implementation are structured through PT Garda Citra Nusantara.</p><a className="textLink" href="/company">About the company →</a></div>
        <div className="directContact"><a href={`mailto:${email}`}>{email} ↗</a>{socials.slice(0,3).map((social) => <a key={social.label} href={social.href} target="_blank" rel="noreferrer">{social.label} ↗</a>)}</div>
