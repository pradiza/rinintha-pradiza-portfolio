  ...
  return (
    <PageShell>
      <section className="contactPage">
        ...
        <div className="corporateEngagement"><span>Formal contracting</span><p>Rinintha leads the work personally. Consultations and larger projects requiring formal contracting, invoicing, vendor onboarding, or local implementation are structured through PT Garda Citra Nusantara.</p></div>
