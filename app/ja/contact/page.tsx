  ...
  return (
    <PageShell locale="ja">
      <section className="contactPage">
        ...
        <div className="contactOptions"><a href={`mailto:${email}?subject=Project%20enquiry%20for%20Rinintha`}>プロジェクトのご相談 <span>↗</span><small>戦略、キャンペーン、リサーチ、イベント、特別企画</small></a><a href="/ja/consultation">インドネシア市場コンサルテーション <span>↗</span><small>USD 100 · 60分の市場参入戦略セッション</small></a><a href={`mailto:${email}?subject=Role%20opportunity%20for%20Rinintha`}>役職・参画のご相談 <span>↗</span><small>正社員、フラクショナル、シニアプロジェクトリーダー</small></a><a href={`mailto:${email}?subject=MC%20or%20translation%20enquiry`}>MC・翻訳 <span>↗</span><small>インドネシア語・英語でのステージ進行、ローカライゼーション</small></a></div>
