...
export const metadata: Metadata = {
  title: "お問い合わせ",
  description: "プロジェクト、役職、コンサルテーション、MC、翻訳、インドネシアと日本を結ぶ協業について、リニンザ　プラディザへお問い合わせください。",
  ...
  return (
    <PageShell locale="ja">
      <section className="contactPage">
        ...
        <p className="contactLead">背景、実現したい成果、時期、そしてリニンザに期待する役割をお知らせください。要点を簡潔にお送りいただければ、より具体的にご回答できます。</p>
        ...
        <div className="corporateEngagement"><span>法人契約</span><p>正式な契約、現地実施、ベンダー登録、継続的な協業が必要な案件は、PT Garda Citra Nusantaraとの法人契約で対応できます。</p><a className="textLink" href="/ja/company">法人情報を見る →</a></div>
