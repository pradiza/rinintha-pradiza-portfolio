  ...
  return (
    <PageShell locale="ja">
      <header className="hero">
        ...
        <div className="heroStage">
          <div className="heroMessage">
            <h1 className="heroHeadlineJa"><span className="jaLine">インサイト →</span><br /><span className="jaLine">アイデア →</span><br /><em><span className="jaLine">心動く体験!</span></em></h1>
      ...
      <section className="profileTeaser">
        ...
        <div><p className="bigCopy"><strong><span className="jaLine"><em>好奇心</em>と</span><wbr /><span className="jaLine">文化の翻訳が</span><br /><span className="jaLine">形づくった</span><wbr /><span className="jaLine">キャリア。</span></strong></p><p className="sectionIntro">深夜の日本音楽ラジオから、エンターテインメント、国際協力、メディア、フェスティバル、クリエイティブリーダーシップ、インドネシアと日本の市場開拓へ。</p><a className="pillButton" href="/ja/profile">プロフィールを見る ↗</a></div>
      </section>
