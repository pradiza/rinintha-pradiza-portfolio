...
export const personalMediaJa = translateNotes(personalMediaEn, [
  ...
  "インドネシアのWorld Cosplay Summit参加についてリニンザのコメントを掲載し、2008年の日イ友好イベントから続く関与を紹介。",
  "元SDN48メンバーで書道家のなちゅをインドネシアへ招聘した経緯とリニンザの役割を取り上げた記事。",
  ...
  "インドネシアでのSTARMARIE公演を報じ、CLAS:HのMCとしてリニンザを紹介した日本語記事。",
  "リニンザへの取材と4曲のJKT48歌詞翻案をもとに、日本語楽曲のインドネシア語化を分析した学術研究。",
...
export const projectPressJa = translateNotes(projectPressEn, [
  ...
  "Hyper Wave Festivalの企画者としてリニンザを紹介し、ビジネス、ファッション、音楽、文化交流の組み合わせを解説。",
